 ...
 */
export function mockFetchWithRateLimit(body: string, options: MockFetchOptions = {}): void {
 ...
 */
export function mockSuccessResponse<T>(data: T, options: MockFetchOptions = {}): void {
